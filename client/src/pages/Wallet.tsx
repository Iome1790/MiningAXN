          ...
          {savedAddress && !addressEditing && (
            <div style={{ marginBottom: 10, marginTop: 4 }}>
              <div style={{
                ...
                <span style={{ color: '#4ade80', fontSize: 11, fontWeight: 700 }}>Withdrawal Address Saved</span>
              </div>
              <div
                onClick={() => {
          ...
          <div style={{ marginTop: savedAddress && !addressEditing ? 6 : 14, marginBottom: 6 }}>
            {addressEditing || !savedAddress ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                <div style={{ fontSize: 11, color: TEXT_DIM, textAlign: 'left', marginBottom: 2 }}>
        ...
        <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 16, padding: '14px', marginBottom: 8 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <div style={{ color: TEXT, fontSize: 14, fontWeight: 700 }}>Axionet (AXN)</div>
                <div style={{ color: TEXT_DIM, fontSize: 11 }}>
                  {tonLoading ? '...' : AXN_PRICE_USD > 0 ? `$${AXN_PRICE_USD.toFixed(6)} / AXN` : 'Mining & App Rewards'}
                </div>
              </div>
            </div>
            <div style={{ textAlign: 'right' }}>
              <div style={{ color: TEXT, fontSize: 15, fontWeight: 800 }}>{poolAxnBalance.toLocaleString()}</div>
              <div style={{ color: TEXT_DIM, fontSize: 11 }}>
